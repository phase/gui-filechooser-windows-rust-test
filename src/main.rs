...
const WIN_W: u32 = gui::WIN_W;
const WIN_H: u32 = gui::WIN_H;
...
pub fn main() {
    ...
    {
        // Construct our `Ui`.
        let mut ui = conrod::UiBuilder::new([WIN_W as f64, WIN_H as f64]).theme(gui::theme()).build();
        ...
        let mut app = gui::DemoApp::new(rust_logo);
